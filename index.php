...
<body>
	...
	<nav class="mb-1 navbar navbar-expand-lg navbar-dark bg-dark">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
		...
		<li class="nav-item">
	        <a class="nav-link" href="#">Tour Builder</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link active" href="index.php">Paket Ziarah
	...
	<!-- konten -->
		<div class="container" style="margin-bottom: 50px;">
			<h2 style="margin-top: 35px;">Paket Ziarah Makam Wali</h2>
	  ...
	  <div class="container text-center text-md-left">
	    ...
	    <div class="row">
	      ...
	      <div class="col-md-4 mx-auto">
	        ...
	        <p>
			“Si-Do’i” (Solusi Dolan Islami) merupakan sebuah aplikasi yang berguna untuk 
			memudahkan peziarah dalam melakukan ziarah makam wali di Indonesia.
	        </p>
	      ...
	      <div class="col-md-3 mx-auto">
	        ...
	        <ul class="list-unstyled">
        	  ...
        	  <p>
          		<i class="fas fa-envelope mr-3"></i> siDoi@gmail.com
          	  </p>
        	  <p>
          		<i class="fas fa-phone mr-3"></i> +6282-301-329-143
          	  </p>
          	</ul>
          	<!-- Links -->
